...
const CreatePoint = () => {
    ...
    // quando no segundo parametro é usado um array vazio esta função só é executada uma vez
    useEffect(() => {
            ...
            <form onSubmit={handleSubmit}>
                ...
                <fieldset>
                    ...
                    <Map center={initialPosition} zoom={15} onClick={handleMapClick}>
                        <TileLayer 
                        attribution='&amp;copy <a hfer="http://osm.org/copyright"> OpenStreetMap</a> contributors' 
